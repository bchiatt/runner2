(function(){
  ...
  .config(['$stateProvider', '$urlRouterProvider', '$httpProvider', function($stateProvider, $urlRouterProvider, $httpProvider){
    ...
    .state('txPlans',     {url:'/txPlans',         templateUrl:'/views/txplans/list.html',       controller:'TxPlansCtrl'})
    .state('txPlan',      {url:'/txPlans/{id}',    templateUrl:'/views/txplans/show.html',       controller:'TxPlanCtrl'})
